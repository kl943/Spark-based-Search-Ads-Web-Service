...
public class AdsServer {
	public static void main(String[] args) throws IOException {
		...
		AdsEngine adsEngine = new AdsEngine(adsDataFilePath,budgetDataFilePath,"","",memcachedServer,memcachedPortal,11218,11219,mysql_host,mysql_db,mysql_user,mysql_pass);
		if(adsEngine.init())
		{
